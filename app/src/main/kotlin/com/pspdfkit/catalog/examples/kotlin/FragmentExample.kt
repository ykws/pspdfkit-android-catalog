...
class CustomFragmentActivity : AppCompatActivity(), DocumentListener, OnDocumentLongPressListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val documentUri = intent.getParcelableExtra<Uri>(EXTRA_URI)
    ...
    private fun initThumbnailGridAndButton() {
        ...
        val openThumbnailGridButton = findViewById<ImageView>(R.id.openThumbnailGridButton)
            ?: throw IllegalStateException("Error while loading CustomFragmentActivity. The example layout" +
    ...
    override fun onDocumentLongPress(document: PdfDocument,
                                     @IntRange(from = 0) pageIndex: Int,
                                     event: MotionEvent?,
                                     pagePosition: PointF?,
                                     longPressedAnnotation: Annotation?): Boolean {
    ...
    override fun onPageClick(document: PdfDocument,
                             @IntRange(from = 0) pageIndex: Int,
                             event: MotionEvent?,
                             pagePosition: PointF?,
                             clickedAnnotation: Annotation?): Boolean = false
