...
private class CustomAnnotationNoteHinter internal constructor(private val pdfActivity: PdfActivity) : PdfDrawableProvider(), OnAnnotationUpdatedListener {
    ...
    override fun getDrawablesForPage(context: Context,
                                     document: PdfDocument,
                                     @IntRange(from = 0) pageIndex: Int): List<PdfDrawable> {
...
private class NoteInkHinterDrawable internal constructor(private val activity: PdfActivity,
                                                         private val noteIcon: Drawable,
                                                         private val annotation: Annotation) : PdfDrawable() {
