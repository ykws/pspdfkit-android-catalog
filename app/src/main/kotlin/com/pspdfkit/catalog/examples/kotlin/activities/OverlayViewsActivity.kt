...
class OverlayViewsActivity : PdfActivity() {
    ...
    override fun onDocumentLoaded(document: PdfDocument) {
        ...
        val clickHereAnnotation = FreeTextAnnotation(0,
...
class MyViewProvider(context: Context,
                     val pdfFragment: PdfFragment,
                     savedInstanceState: Bundle?) : OverlayViewProvider() {
    ...
    init {
        ...
        firstPageView.layoutParams = OverlayLayoutParams(RectF(350f, 900f, 768f, 700f),
        ...
        secondPageView.layoutParams = OverlayLayoutParams(RectF(0f, 1024f, 768f, 0f),
