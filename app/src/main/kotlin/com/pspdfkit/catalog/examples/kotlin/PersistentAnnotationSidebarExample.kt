...
class PersistentAnnotationSidebarExample(context: Context) : PSPDFExample(context.getString(R.string.annotationSidebarExampleTitle), context.getString(R.string.annotationSidebarExampleDescription)) {
...
class PersistentAnnotationSidebarActivity : AppCompatActivity() {
    ...
    private fun obtainPdfFragment() {
        ...
        pdfUiFragment = supportFragmentManager.findFragmentByTag(FRAGMENT_TAG) as? PdfUiFragment
            ...
            ?: PdfUiFragmentBuilder.fromUri(this, intent.extras!!.getParcelable(EXTRA_URI))
                .configuration(intent.extras!!.getParcelable(EXTRA_CONFIGURATION))
                .build()
                .apply {
