 ...
 */
class AnnotationConfigurationExample(context: Context) : PSPDFExample(context, R.string.annotationConfigurationExampleTitle, R.string.annotationConfigurationExampleDescription) {
