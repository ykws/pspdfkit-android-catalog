...
import com.pspdfkit.catalog.examples.java.instant.activities.BarcodeActivity
...
class InstantExampleConnectionActivity : AppCompatActivity() {
    ...
    /**
     * Consumer for [WebPreviewClient] async methods.
     */
    private val apiConsumer = BiConsumer<InstantExampleDocumentDescriptor, Throwable> { documentDescriptor, throwable ->
        if (throwable != null) {
