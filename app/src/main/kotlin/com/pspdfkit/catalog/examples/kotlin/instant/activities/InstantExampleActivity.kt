...
class InstantExampleActivity : InstantPdfActivity(), ActionMenuListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val documentDescriptor: InstantExampleDocumentDescriptor? = intent.getParcelableExtra(DOCUMENT_DESCRIPTOR)
    ...
    private fun showOpenInBrowserMenu() {
        ...
        val sharingMenu = SharingMenu(this, SharingMenu.SharingMenuListener { shareTarget ->
