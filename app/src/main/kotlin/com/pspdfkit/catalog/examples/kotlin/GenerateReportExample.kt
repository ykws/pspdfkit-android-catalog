...
class GenerateReportExample(context: Context) : PSPDFExample(context, R.string.generateReportExampleTitle, R.string.generateReportExampleDescription) {
    ...
    override fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        ...
        generationDisposable = Single.fromCallable {
            ...
            val sourceDocument = PdfDocumentLoader.openDocument(context, DocumentSource(AssetDataProvider("JKHF-AnnualReport.pdf")))
            ...
            val guideDocument = PdfDocumentLoader.openDocument(context, DocumentSource(AssetDataProvider("Guide-v4.pdf")))
