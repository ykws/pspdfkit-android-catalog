...
class AnnotationCreationExample(context: Context) : PSPDFExample(context, R.string.annotationCreationExampleTitle, R.string.annotationCreationExampleDescription) {
    override fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        ...
        configuration.editableAnnotationTypes(listOf(
            AnnotationType.NOTE,
        ...
        // is editable.
        configuration.enabledAnnotationTools(listOf(
...
class AnnotationCreationActivity : PdfActivity() {
    ...
    private fun createHighlightAnnotation(@IntRange(from = 0) pageIndex: Int,
    ...
    private fun createSoundAnnotation(pageIndex: Int) {
        try {
            ...
            val audioExtractor = AudioExtractor(this, Uri.parse("file:///android_asset/inline-media/videos/small.mp4"))
