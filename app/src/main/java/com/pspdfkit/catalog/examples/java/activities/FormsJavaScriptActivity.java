 ...
 * <p>
 * <b>Note:</b> For more information about JavaScript API refer to our guides or to Adobe's
 * <a href="https://www.adobe.com/content/dam/acom/en/devnet/acrobat/pdfs/js_api_reference.pdf">JavaScript for Acrobat API Reference</a>.
 *
...
public class FormsJavaScriptActivity extends PdfActivity {
    ...
    private void createSimpleCalculationExample() {
        ...
        document.getFormProvider().addFormElementToPage(
                ...
                new TextFormConfiguration.Builder(0, new RectF(30, 750, 200, 720))
                        .setAdditionalAction(
                                // FORM_CHANGED additional action is executed for each keystroke when editing form field.
                                AnnotationTriggerEvent.FORM_CHANGED,
                                // Accept only numbers with 2 decimal places, ',' as thousands and '.' as decimal separators.
                                new JavaScriptAction("AFNumber_Keystroke(2, 0, 0, 0, '', true);"))
                        .setAdditionalAction(
                                // FIELD_FORMAT action is executed to format field contents whenever form field's value changes.
                                AnnotationTriggerEvent.FIELD_FORMAT,
                                // Keystroke and format functions accepts the same arguments.
        ...
        document.getFormProvider().addFormElementToPage(
                ...
                new TextFormConfiguration.Builder(0, new RectF(30, 690, 200, 660))
                        .setAdditionalAction(
                                AnnotationTriggerEvent.FORM_CHANGED,
                                // Accept only numbers with 0 decimal places, and no thousands separator.
        ...
        document.getFormProvider().addFormElementToPage(
                ...
                new TextFormConfiguration.Builder(0, new RectF(30, 630, 200, 600))
                        .setAdditionalAction(
                                // FORM_CALCULATE additional action is executed whenever value of any form field in the document changes.
                                AnnotationTriggerEvent.FORM_CALCULATE,
                                // Use AFSimple_Calculate function to perform simple calculations for multiple source (operand) fields.
                                // Other supported functions are: AVG (average), PRD (product), MIN (minimum) and MAX (maximum)
                                new JavaScriptAction("AFSimple_Calculate('SUM', new Array('sum-operand1', 'sum-operand2'));"))
                        .setAdditionalAction(
                                AnnotationTriggerEvent.FIELD_FORMAT,
                                // In this example we'll format the field to have 2 decimal places and use '.' as decimal separator.
        ...
        document.getFormProvider().addFormElementToPage(
                ...
                new TextFormConfiguration.Builder(1, new RectF(30, 630, 200, 600))
                        .setAdditionalAction(
                                // FORM_CALCULATE additional action is executed whenever value of any form field in the document changes.
                                AnnotationTriggerEvent.FORM_CALCULATE,
                                // Concatenate text in operand text fields and set it to the result field.
    ...
    /**
     * Creates multiple text fields with different formatting and validation scripts to showcase basic formatting options.
     */
    private void createFormattingExample() {
        ...
        // Uses AFNumber_*(nDec, sepStyle, negStyle, currStyle, strCurrency, bCurrencyPrepend) function.
        document.getFormProvider().addFormElementToPage(
                "Number format",
                new TextFormConfiguration.Builder(2, new RectF(30, 750, 200, 720))
                        .setAdditionalAction(
                                ...
                                new JavaScriptAction("AFNumber_Keystroke(2, 0, 0, 0, '', true);"))
                        .setAdditionalAction(
                                // FIELD_FORMAT action is executed whenever form field's value changes to format it's contents.
                                AnnotationTriggerEvent.FIELD_FORMAT,
    ...
    /**
     * Creates a checkbox form field that toggles visibility of push button created in {@link #createPushButtonWithImageImportAction()} when checked.
     */
    private void createCheckboxWithHideAction() {
        ...
        CheckBoxFormConfiguration.Builder builder = new CheckBoxFormConfiguration.Builder(
                3,
                new RectF(150, 690, 180, 660))
                .deselect()
                .setAdditionalAction(
                        // MOUSE_UP additional action is executed after clicking on the form field.
