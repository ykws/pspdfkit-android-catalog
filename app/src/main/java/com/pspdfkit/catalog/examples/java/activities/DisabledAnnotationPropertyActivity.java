...
/**
 * Shows how to use {@link AnnotationConfiguration} to disable annotation note option from the annotation editing
 * toolbar by removing the {@link AnnotationProperty#ANNOTATION_NOTE} from the supported properties.
 */
public class DisabledAnnotationPropertyActivity extends PdfActivity {
    ...
    public void onDocumentLoaded(@NonNull PdfDocument document) {
        ...
        //noinspection ConstantConditions - When a document is successfully loaded fragment won't be null.
