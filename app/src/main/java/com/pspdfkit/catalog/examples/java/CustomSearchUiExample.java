 ...
 * custom activity {@link CustomSearchUiActivity} which will manage creation of the new layout as well
...
public class CustomSearchUiExample extends PSPDFExample {
    ...
    public CustomSearchUiExample(@NonNull final Context context) {
        super(context.getString(R.string.customSearchUiExampleTitle), context.getString(R.string.customSearchUiExampleDescription));
    }
