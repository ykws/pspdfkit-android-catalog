...
/**
 * This example activity adds a navigation drawer menu to the default {@link PdfActivity} which allows to
 * navigate between different documents within the same activity.
 */
public class DocumentSwitcherActivity extends PdfActivity {
     ...
     */
    private static final String[] assetFiles = new String[]{"Guide-v6.pdf", "Guide-v5.pdf", "Guide-v4.pdf", "Annotations.pdf"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // We create a list of documents that can be loaded by this example. In a real-word scenario this list would
        // probably be dynamic.
        ...
        drawerListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            // Document was not found in the document coordinator - create it manually before showing.
        ...
        final TypedArray a = getTheme().obtainStyledAttributes(null, com.pspdfkit.R.styleable.pspdf__ActionBarIcons, com.pspdfkit.R.attr.pspdf__actionBarIconsStyle, com.pspdfkit.R.style.PSPDFKit_ActionBarIcons);
        int toolbarIconsColor = a.getColor(com.pspdfkit.R.styleable.pspdf__ActionBarIcons_pspdf__iconsColor, ContextCompat.getColor(this, com.pspdfkit.R.color.pspdf__color_white));
        a.recycle();
    ...
    /**
     * If the user presses the navigation drawer icon, we toggle the drawer visibility. Otherwise we pass the event
     * on to the default implementation.
     */
    @Override
