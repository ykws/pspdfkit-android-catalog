...
/**
 * This example shows how to incorporate form editing UI into
 * the custom activity using {@link PdfFragment}. This includes 2 UI components:
 * <ul>
 *     <li>Form editing bar - helps with form filling, provides buttons for navigating between form elements when editing forms.
 *     Usually displayed above soft-keyboard or at the bottom of the screen.</li>
 *     <li>Form editing inspector - bottom sheet showing options of choice form elements ({@link ComboBoxFormElement} and {@link ListBoxFormElement})</li>
 * </ul>
 */
public class FormEditingInFragmentActivity extends AppCompatActivity implements FormManager.OnFormElementEditingModeChangeListener {
    ...
    /**
     * Coordinator for property inspectors displayed in bottom sheet. Needs to be part of the activity layout.
     */
    ...
    /**
     * Auxiliary view that provides buttons for navigating between form fields in tab order, clearing form field and finishing form editing.
     */
    ...
    private void initPdfFragment(@NonNull Uri uri, @NonNull PdfConfiguration configuration) {
        ...
        // Register listener for form element editing mode changes. We'll use this to bind our form editing UI to form editing controller.
    ...
    public void onEnterFormElementEditingMode(@NonNull FormEditingController controller) {
        // When entering the form editing mode we need to bind required UI components to provided form editing controller.
    ...
    public void onChangeFormElementEditingMode(@NonNull FormEditingController controller) {
        // Nothing to be done here, bound form editing bar and form editing inspector controller will pick up the changes.
    }
