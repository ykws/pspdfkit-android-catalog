...
/**
 * This example shows how to create a custom share dialog using {@link DocumentSharingDialogFactory}.
 */
    ...
    public static class CustomSharingDialog extends BaseDocumentSharingDialog {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            dialogLayout.positiveButton.setOnClickListener(v -> {
                // Once the user is done making changes be sure to call the listener with your SharingOptions.
                if (getListener() != null) {
        ...
        private SharingOptions getSharingOptions() {
            // If the checkbox is checked we flatten the annotations so they can't be edited in the shared document.
