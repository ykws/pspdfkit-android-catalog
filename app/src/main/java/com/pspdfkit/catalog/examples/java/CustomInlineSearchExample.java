...
/**
 * This example takes the {@link PdfSearchViewInline} and places it inside a custom layout. To do so it uses a
 * custom activity {@link CustomInlineSearchExampleActivity} which will manage creation of the new layout as well
 * as showing and hiding of the inline search.
 */
public class CustomInlineSearchExample extends PSPDFExample {
    ...
    public CustomInlineSearchExample(@NonNull final Context context) {
        super(context.getString(R.string.customInlineSearchExampleTitle), context.getString(R.string.customInlineSearchExampleDescription));
    }

    @Override
    public void launchExample(@NonNull final Context context, @NonNull final PdfActivityConfiguration.Builder configuration) {
        // This example requires inline search, so override any catalog configuration.
        // To change the location of the PdfSearchViewInline as well as the way it is integrated, you have to use a custom activity.
