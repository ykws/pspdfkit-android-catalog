...
/**
 * This activity shows how to create various semi-transparent annotations programmatically. Also have a look
 * at the {@link AnnotationWithAlphaCreationExample} class.
 */
public class AnnotationWithAlphaCreationActivity extends PdfActivity {
    ...
    private void createLineAnnotation(@IntRange(from = 0) final int pageIndex) {
        final LineAnnotation lineAnnotation = new LineAnnotation(
            pageIndex,
            new PointF(400, 100), new PointF(500, 100)
        );
