...
/**
 * This activity showcases how to implement custom sharing actions. For sharing to work you need to declare
 * {@link DocumentSharingProvider} in your {@code AndroidManifest.xml}.
 */
public class DocumentSharingExampleActivity extends PdfActivity {
    ...
    private void customSharingDialog() {
        ...
        final DocumentSharingDialogConfiguration configuration =
            new DocumentSharingDialogConfiguration.Builder(this, getDocument(), getPageIndex())
    ...
    private void shareFromRange() {
        ...
        final List<Range> extractedPages = SharingOptions.parsePageRange("3-5,11", getDocument().getPageCount());
     ...
     * Note that standard {@link ShareAction#SEND} shares to all apps that accept PDF files - mail apps,
     * file managers, social network apps etc.
     */
