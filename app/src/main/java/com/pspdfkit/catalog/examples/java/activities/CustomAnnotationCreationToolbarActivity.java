...
/**
 * This example shows how to manipulate annotation creation toolbar to add your own annotation tool items.
 * In this example we add three line annotation tools, each of them for drawing lines of different colors.
 */
public class CustomAnnotationCreationToolbarActivity extends PdfActivity implements
    ...
    @Nullable private Drawable blueLineIcon;
    @Nullable private Drawable redLineIcon;
    @Nullable private Drawable yellowLineIcon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redLineIcon = AppCompatResources.getDrawable(this, R.drawable.pspdf__ic_line);
    ...
    public void onDocumentLoaded(@NonNull PdfDocument document) {
        ...
        if (pdfFragment != null) {
            ...
            annotationConfiguration.put(AnnotationTool.LINE, AnnotationToolVariant.fromName(VARIANT_NAME_LINE_BLUE),
            ...
            annotationConfiguration.put(AnnotationTool.LINE, AnnotationToolVariant.fromName(VARIANT_NAME_LINE_RED),
                LineAnnotationConfiguration.builder(this) // Use preset configuration for creating lines.
            ...
            annotationConfiguration.put(AnnotationTool.LINE, AnnotationToolVariant.fromName(VARIANT_NAME_LINE_YELLOW),
                LineAnnotationConfiguration.builder(this) // Use preset configuration for creating lines.
    ...
    public void onPrepareContextualToolbar(@NonNull ContextualToolbar toolbar) {
        if (toolbar instanceof AnnotationCreationToolbar) {
            ...
            List<ContextualToolbarMenuItem> customMenuItems = new ArrayList<>();

            if (blueLineIcon != null) {
                ContextualToolbarMenuItem blueLineItem = ContextualToolbarMenuItem.createSingleItem(this,
                    R.id.line_blue,
                    blueLineIcon,
                    "Line: Blue",
                    Color.WHITE,
            ...
            if (redLineIcon != null) {
                ContextualToolbarMenuItem redLineItem = ContextualToolbarMenuItem.createSingleItem(this,
                    R.id.line_red,
                    redLineIcon,
                    "Line: Red",
                    Color.WHITE,
            ...
            if (yellowLineIcon != null) {
                ContextualToolbarMenuItem yellowLineItem = ContextualToolbarMenuItem.createSingleItem(this,
                    R.id.line_yellow,
                    yellowLineIcon,
                    "Line: Yellow",
                    Color.WHITE,
    ...
    public SparseArray<Pair<AnnotationTool, AnnotationToolVariant>> getItemToAnnotationToolMapping() {
        ...
        SparseArray<Pair<AnnotationTool, AnnotationToolVariant>> itemToAnnotationToolMapping = new SparseArray<>();
        itemToAnnotationToolMapping.put(R.id.line_blue, new Pair<>(AnnotationTool.LINE, AnnotationToolVariant.fromName(VARIANT_NAME_LINE_BLUE)));
        itemToAnnotationToolMapping.put(R.id.line_red, new Pair<>(AnnotationTool.LINE, AnnotationToolVariant.fromName(VARIANT_NAME_LINE_RED)));
        itemToAnnotationToolMapping.put(R.id.line_yellow, new Pair<>(AnnotationTool.LINE, AnnotationToolVariant.fromName(VARIANT_NAME_LINE_YELLOW)));
        return itemToAnnotationToolMapping;
    }

    @Override // AnnotationCreationToolbar.ItemToAnnotationToolMapper
    public boolean isStyleIndicatorCircleEnabled(int itemId) {
        // We want to show style indicators for all our custom items and not show it for all the default ones.
        return getItemToAnnotationToolMapping().get(itemId) != null;
    }

    /**
     * Class that implements the {@link PresetMenuItemGroupingRule}, used to tell the toolbar how
     * to group menu items in the toolbar.
     * @see com.pspdfkit.catalog.ui.CustomAnnotationCreationToolbarGroupingRule for more details.
     */
    private class CustomAnnotationCreationToolbarGroupingRule extends PresetMenuItemGroupingRule {

        private final List<MenuItem> CUSTOM_GROUPING = new ArrayList<>(4);

        CustomAnnotationCreationToolbarGroupingRule(@NonNull Context context) {
            super(context);
            ...
            // This adds line items under our group item ('writing' in this case). You can also use your own
            ...
            CUSTOM_GROUPING.add(new MenuItem(com.pspdfkit.R.id.pspdf__annotation_creation_toolbar_item_ink_highlighter));
