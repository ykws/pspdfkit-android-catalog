...
/**
 * This activity showcases how to add custom sharing action to sharing menu displayed in a {@link BottomSheetDialog}.
 */
public class CustomSharingMenuActivity extends PdfActivity implements ActionMenuListener {
    ...
    /**
     * Example implementation of a custom share controller that shares document to single {@link ShareTarget}.
     */
