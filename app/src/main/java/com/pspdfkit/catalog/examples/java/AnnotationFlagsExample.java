...
/**
 * Shows how to use {@link com.pspdfkit.annotations.AnnotationFlags} to modify annotation characteristics.
 */
public class AnnotationFlagsExample extends PSPDFExample {

    public AnnotationFlagsExample(@NonNull final Context context) {
        super(context.getString(R.string.annotationFlagsExampleTitle), context.getString(R.string.annotationFlagsExampleDescription));
    }
    ...
    public void launchExample(@NonNull final Context context, @NonNull final PdfActivityConfiguration.Builder configuration) {
        configuration
            ...
            // We override this behavior here by enabling NOZOOM flag handling for note annotations.
        ...
        ExtractAssetTask.extract(ANNOTATIONS_EXAMPLE, title, context, documentFile -> {
            // To start the AnnotationFlagsActivity create a launch intent using the builder.
