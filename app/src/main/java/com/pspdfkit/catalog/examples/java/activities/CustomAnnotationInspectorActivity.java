...
/**
 * Shows how to implement custom {@link AnnotationInspectorController} and how to add custom views to existing annotation inspector.
 */
public class CustomAnnotationInspectorActivity extends PdfActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DefaultAnnotationEditingInspectorController customAnnotationEditingInspector = new DefaultAnnotationEditingInspectorController(
            this,
            ...
            public void onPreparePropertyInspector(@NonNull PropertyInspector inspector) {
                ...
                final Annotation annotation = getAnnotationEditingController().getCurrentlySelectedAnnotation();
                if (annotation == null || annotation.getType() != AnnotationType.INK) return;

                final ColorPickerInspectorDetailView colorPickerInspectorDetailView = new ColorPickerInspectorDetailView(
    ...
    /**
     * Custom implementation of the {@link AnnotationCreationInspectorController} showing simplified annotation inspector in a dialog.
     */
    private class CustomAnnotationCreationInspector implements AnnotationCreationInspectorController {
        ...
        @Nullable private AnnotationCreationController controller;
        @Nullable private AlertDialog dialog;

        @Nullable private Bundle restoredInstanceState;
