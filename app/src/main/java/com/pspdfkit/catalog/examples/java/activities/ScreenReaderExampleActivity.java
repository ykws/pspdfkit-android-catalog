...
public class ScreenReaderExampleActivity extends PdfActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // In case of a failure (usually because of a missing TTS engine) the example will be stopped.
        screenReader = new ScreenReader(this, new ScreenReader.OnInitListener() {
            ...
            public void onInitializationFailed() {
                new AlertDialog.Builder(ScreenReaderExampleActivity.this)
                    .setTitle("Error")
                    .setMessage("Could not initiate text-to-speech engine. This may happen if your device does not have a local TTS " +
    ...
    protected void onStop() {
        super.onStop();
        // When the activity goes to the background we stop any running TTS process and clean up drawable providers.
    ...
    public void onDocumentLoaded(@NonNull PdfDocument document) {
        // If the screen reader is initialized upon loading the document start reading on the current page.
