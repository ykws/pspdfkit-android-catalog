...
/**
 * Example activity showing how to draw custom drawables on the {@link PdfFragment},
 * the {@link PdfThumbnailGrid}, and the {@link PdfThumbnailBar} using Drawable API.
 */
public class WatermarkExampleActivity extends PdfActivity {
    ...
    /**
     * An implementation of {@link PdfDrawable},
     * which shows two semi-transparent squares in the bottom-left corner.
     */
    ...
    /**
     * An implementation of {@link PdfDrawable}, which shows a semi-transparent text tilted by 45 degrees.
     */
    class WatermarkDrawable extends PdfDrawable {
        ...
        private void calculatePageCoordinates(String text, Point point) {
            ...
            pageCoordinates.set(
                point.x, point.y + textBounds.height(),
                point.x + textBounds.width(), point.y
            );
        }
