...
/**
 * This example showcases how to use {@link AnnotationSelectionController} to dynamically modify properties of current annotation selection.
 */
public class AnnotationSelectionCustomizationExample extends PSPDFExample {
    ...
    public void launchExample(@NonNull final Context context, @NonNull final PdfActivityConfiguration.Builder configuration) {
        ...
        ExtractAssetTask.extract(QUICK_START_GUIDE, title, context, documentFile -> {
            // To start the AnnotationSelectionCustomizationActivity create a launch intent using the builder.
