...
public class VerticalScrollbarExampleActivity extends PdfActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // The scrollbar widget has already been inflated from the layout file defined via the configuration.
        verticalScrollBar = findViewById(R.id.customScrollbar);

        // The scrollbar also works for horizontally scrolled documents. We need to manually tell it the used scroll direction.
        verticalScrollBar.setScrollDirection(getConfiguration().getConfiguration().getScrollDirection());
        ...
        // The scrollbar widget emits page change events (whenever the user drags the scroll indicator).
    ...
    public void onDocumentLoaded(@NonNull PdfDocument document) {
        // Prepare the scrollbar widget: You need to set the controlled document as well as the configured scroll direction.
