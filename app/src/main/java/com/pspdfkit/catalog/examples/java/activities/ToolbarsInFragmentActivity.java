...
/**
 * This example shows how to incorporate {@link ContextualToolbar}s into
 * the custom activity using {@link PdfFragment} with all the animations and dragging managed
 * by the {@link ToolbarCoordinatorLayout}.
 */
public class ToolbarsInFragmentActivity extends AppCompatActivity implements AnnotationManager.OnAnnotationCreationModeChangeListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // The actual document Uri is provided with the launching intent. You can simply change that inside the ToolbarsInFragmentExample class.
