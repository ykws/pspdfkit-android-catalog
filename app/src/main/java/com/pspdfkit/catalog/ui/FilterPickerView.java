...
/**
 * A view used in {@link FilterableThumbnailGridExample} to provide
 * filtering options in the thumbnail grid header. See example's documentation for more info.
 */
public class FilterPickerView extends LinearLayout {

    @NonNull private final List<Filter> filters = new ArrayList<>();
    @Nullable private Filter selectedFilter = null;
    @Nullable private OnFilterClickedListener listener = null;

    @ColorInt private int backgroundColor;
    @ColorInt private int foregroundColor;
    @ColorInt private int backgroundColorSelected;
    @ColorInt private int foregroundColorSelected;
    ...
    public FilterPickerView(@NonNull final Context context) {
        ...
        int padding = (int) getContext().getResources().getDimension(R.dimen.pspdf__thumbnailGridFilterPickerViewPadding);
    ...
    private void generateLayout() {
        ...
        for (Filter filter : filters) {
            ...
            int padding = (int) getContext().getResources().getDimension(R.dimen.pspdf__thumbnailGridFilterPickerViewSelectionPadding);
