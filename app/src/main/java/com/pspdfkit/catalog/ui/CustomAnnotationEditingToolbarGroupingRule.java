...
/**
 * Grouping rule for annotation editing toolbar with our custom menu item.
 * See {@link AnnotationFlagsActivity} or {@link AnnotationOverlayActivity} for usage example.
 */
public class CustomAnnotationEditingToolbarGroupingRule extends AnnotationEditingToolbarGroupingRule {
    ...
    public List<MenuItem> getGroupPreset(int capacity, int itemsCount) {
        ...
        List<com.pspdfkit.ui.toolbar.grouping.presets.MenuItem> groupPreset = new ArrayList<>(super.getGroupPreset(capacity - 1, itemsCount - 1));
